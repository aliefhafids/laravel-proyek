        ...
        <div class="content-wrapper">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0">Welcome to Manajemen Haryanto, <span class="text-primary">Let's work</span> with it</h6>
                </div>
                ...
                <div class="card-people mt-auto">
                  ...
                  <div class="weather-info">
                    <div class="d-flex">
                      ...
                      <div class="ml-2">
                        <h4 class="location font-weight-normal">solo</h4>
          ...
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Assets Haryanto</p>
                  <p class="font-weight-500">The total number of sessions within the date range. It is the period time a user is actively engaged with your website, page or app, etc</p>
                  <div class="d-flex flex-wrap mb-5">
                    <div class="mr-5 mt-3">
                      <p class="text-muted">Pendapatan perbulan</p>
                      <h3 class="text-primary fs-30 font-weight-medium">30.2 jt</h3>
                    </div>
                    <div class="mr-5 mt-3">
                    ...
                    <div class="mt-3">
                      <p class="text-muted">Jumlah Bus</p>
